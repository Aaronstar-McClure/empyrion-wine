...
RUN         dpkg --add-architecture i386 \
            ...
            && apt-get install -y tree tar software-properties-common gnupg wget curl gcc g++ lib32gcc1 lib32tinfo5 lib32z1 lib32stdc++6 libtinfo5:i386 libncurses5:i386 libcurl3-gnutls:i386 iproute2 gdb libsdl1.2debian libfontconfig \
